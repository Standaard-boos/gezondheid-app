...
<div class="container-form">
    <form class="form" style="margin-bottom: 0px" action="/waarden" method="post">
        <h1 class="sub-title" style="margin-bottom: 20px">Gegevens invoegen</h1>
        ...
        <h2 class="sub-title" style="margin-bottom: 20px">Waardes in grammen</h2>
    ...
    <form class="form" style="margin-top: 25px" action="/waarden" method="post">
