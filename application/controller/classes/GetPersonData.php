...
class GetPersonData
{
    ...
    public function GetData()
    {
        ...
        echo "<p style='text-align: center; font-size: 20px; font-weight: bold; margin-bottom: 10px'>Welkom " . $_SESSION['user_name'] . "</p>";
        echo "<p>Username: " . $username . "</p><p> Gewicht: " . $gewicht . "</p><p> Lengte: " . $lengte . "</p><p> Leeftijd: " . $leeftijd . "</p><p>Roker: <b>" . $roken . "</b></p>" . "<p>Drugs gebruiker: <b>" . $drugs . "</b></p>";
    }
}
