...
$(document).ready(function ()
{
        ...
        success: function (data)
        {
            ...
            $.ajax({
                ...
                success: function (data2)
                {
                    ...
                    if(data2[0] < 6 ){
                        gescoordePunten = gescoordePunten - 1;
                    }
                    if(data2[0] < 3 ){
                        gescoordePunten = gescoordePunten - 2;
                    }
                    ...
                    if(data2[1] > 10){
                        gescoordePunten = gescoordePunten - 10;
                    }
                    if(data2[2] < 6){
                        gescoordePunten = gescoordePunten -2;
                    }
                    ...
                    if(data2[3] < 5){
                        ...
                        gescoordePunten = gescoordePunten -5;
                    }
                    if(data2[3] < 2){
                    ...
                    if(data2[3] < 7){
                        ...
                        gescoordePunten = gescoordePunten -3;
                    }
                    if(data2[3] < 9){
                    ...
                    if(gescoordePunten < 0){
                        
                        gescoordePunten = 0;
                    }
                    if(gescoordePunten > 12){
    ...
    var opts = {
        ...
        //radiusScale: 0.84, // Relative radius default
        radiusScale: 0.60, // Relative radius
